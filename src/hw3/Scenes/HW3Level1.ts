...
export default class Level1 extends HW3Level {
    ...
    public static readonly PLAYER_SPRITE_PATH = "hw4_assets/spritesheets/poly_rock.json";
    ...
    //
    public static readonly DYING_KEY = "DYING_SOUND";
    public static readonly DYING_SOUND_PATH = "hw4_assets/sounds/dying.wav";
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.dyingKey = Level1.DYING_KEY;
    ...
    public loadScene(): void {
        ...
        this.load.audio(this.dyingKey, Level1.DYING_SOUND_PATH);
    }
    ...
    public unloadScene(): void {
        ...
        this.load.keepAudio(this.dyingKey);
    }
